...
class Form extends React.Component{
    ...
    render(){
        ...
        return(
            <form>
                <input type="text" value={note} onChange={this.insertNote} placeholder='Enter note' required/>
                <input type="text" value={amount} onChange={this.insertAmount} placeholder='Enter amount' required/>
